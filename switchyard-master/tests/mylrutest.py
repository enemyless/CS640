...
def hub_tests():
    ...
    # test case 5: a frame with dest address of one of the interfaces should
    # result in nothing happening
    ...
    s.expect(PacketInputEvent("eth1", reqpkt, display=Ethernet), "from 30:00:00:00:00:01 to 30:00:00:00:00:04 arrives on eth1")
    ...
    s.expect(PacketInputEvent("eth3", reqpkt, display=Ethernet), "from 30:00:00:00:00:02 to 30:00:00:00:00:01 arrives on eth3")
    ...
    s.expect(PacketInputEvent("eth2", reqpkt, display=Ethernet), "from 30:00:00:00:00:03 to 30:00:00:00:00:01 arrives on eth2")
    s.expect(PacketOutputEvent("eth1", testpkt , display=Ethernet), "eth1")

    # test case 9
    reqpkt = mk_pkt("30:00:00:00:00:04", "30:00:00:00:00:01", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth2", reqpkt, display=Ethernet), "from 30:00:00:00:00:04 to 30:00:00:00:00:01 arrives on eth2")
    s.expect(PacketOutputEvent("eth1", testpkt , display=Ethernet), "eth1")

    # test case 7
    reqpkt = mk_pkt("30:00:00:00:00:05", "30:00:00:00:00:01", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth3", reqpkt, display=Ethernet), "from 30:00:00:00:00:05 to 30:00:00:00:00:01 arrives on eth3")
    s.expect(PacketOutputEvent("eth1", testpkt , display=Ethernet), "eth1")

    # test case 8
    reqpkt = mk_pkt("30:00:00:00:00:06", "30:00:00:00:00:02", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth0", reqpkt, display=Ethernet), "from 30:00:00:00:00:06 to 30:00:00:00:00:02 arrives on eth1")
    ...
    s.expect(PacketInputEvent("eth0", reqpkt, display=Ethernet), "from 30:00:00:00:00:05 to 30:00:00:00:00:03 arrives on eth0")
    s.expect(PacketOutputEvent("eth2", testpkt, display=Ethernet), "eth2")

    # test case 10
    reqpkt = mk_pkt("30:00:00:00:00:01", "30:00:00:00:00:04", '192.168.1.100','172.16.42.2')
    s.expect(PacketInputEvent("eth0", reqpkt, display=Ethernet), "from 30:00:00:00:00:01 to 30:00:00:00:00:04 arrives on eth0")
